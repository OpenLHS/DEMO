 ...
 * [DEMO.yml](DEMO.yml)
     * Determines how your purl.obolibrary.org/obo/DEMO/ redirects will be handled
     ...
     * Paste in the contents of [DEMO.yml](DEMO.yml)
 ...
 * [DEMO.md](DEMO.md)
     ...
     * Paste in the contents of [DEMO.md](DEMO.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
